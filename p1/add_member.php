<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // Insert data into the database (assuming the table name is "members")
        $insert_query = "INSERT INTO members (name, gender, dob, contact, email, address) VALUES ('$name', '$gender', '$dob', '$contact', '$email', '$address')";
